	...
	ReentrancyGuardUpgradeable
{
    ...
    */
	 ...
	 */
	function allowListMintsRemaining(
		address user
	...
	*/
	...
	function withdraw(
		uint256 _amount
	) external onlyRole(DEFAULT_ADMIN_ROLE) hasVault {
	...
	function setBigBearSyndicateAddress(
		IBigBearSyndicate bbs_
